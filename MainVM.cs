...
namespace Framework.ViewModel
{
    public class MainVM : BaseVM
    {
        ...
        public Canvas InitialCanvas { get; set; }
        ...
        public Bitmap InitialBitmap
        {
            get => _initialBitmap;
            set
            {
                _initialBitmap = value;
                NotifyPropertyChanged(nameof(InitialBitmap));
            }
        }
        ...
        public Bitmap ProcessedBitmap
        {
            ...
            set
            {
                ...
                NotifyPropertyChanged(nameof(ProcessedBitmap));
            }
        }
        ...
        private ImageSource _lastProcessedImage;
        public ImageSource LastProcessedImage
        {
            get => _lastProcessedImage;
            set
            {
                _lastProcessedImage = value;
                NotifyPropertyChanged(nameof(LastProcessedImage));
            }
        }
