...
namespace Framework.View
{
    public partial class MainWindow : Window
    {
        ...
        public MainWindow()
        {
            ...
            _mainVM = new MainVM();
            DataContext = _mainVM;
            _mainVM.InitialCanvas = initialImageCanvas; // Asigură-te că ai un `Canvas` numit `initialImageCanvas` în XAML
            InitializeThemeMode();
        }
        ...
        private void ImageMouseLeftButtonDown(object sender, MouseButtonEventArgs e)
        {
            ...
            {
                viewModel.MenuCommands.OnImageMouseLeftButtonDown(position);
            }
        }
